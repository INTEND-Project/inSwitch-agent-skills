...
Wheneven possible, use helm command, instead of reading and parsing the helm chart files using list dir or read file. If helm is not installed, follow the Setup section to install it first. 
